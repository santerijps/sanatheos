...
│       ├── translations.json     # Available translation codes list
...
| `renderInterlinearWord` | Single interlinear word with original text and details |
| `renderInterlinearVerse` | Verse with interlinear word-by-word display |
| `renderInterlinearChapterVerses` | Full chapter in interlinear mode |
...
8. Minifies HTML by stripping comments, collapsing whitespace, removing inter-tag spaces. Iterates over `["index.html", "dictionary.html", ...moreFiles]`.
