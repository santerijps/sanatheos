...
const WEB: Record<string, BookEntry> = {
  ...
  "Exodus":         { display: "Exodus",               aliases: ["exod", "ex"] },
  "Leviticus":      { display: "Leviticus",            aliases: ["lev"] },
  "Numbers":        { display: "Numbers",              aliases: ["num"] },
  "Deuteronomy":    { display: "Deuteronomy",          aliases: ["deut", "dt"] },
  "Joshua":         { display: "Joshua",               aliases: ["josh"] },
  "Judges":         { display: "Judges",               aliases: ["judg", "jdg"] },
  "Ruth":           { display: "Ruth",                 aliases: ["ru"] },
  "1 Samuel":       { display: "1 Samuel",             aliases: ["1 sam", "1sam"] },
  "2 Samuel":       { display: "2 Samuel",             aliases: ["2 sam", "2sam"] },
  "1 Kings":        { display: "1 Kings",              aliases: ["1 kgs", "1kgs"] },
  "2 Kings":        { display: "2 Kings",              aliases: ["2 kgs", "2kgs"] },
  "1 Chronicles":   { display: "1 Chronicles",         aliases: ["1 chr", "1chr", "1 chron"] },
  "2 Chronicles":   { display: "2 Chronicles",         aliases: ["2 chr", "2chr", "2 chron"] },
  ...
  "Matthew":        { display: "Matthew",              aliases: ["matt", "mt"] },
  "Mark":           { display: "Mark",                 aliases: ["mk"] },
  "Luke":           { display: "Luke",                 aliases: ["lk"] },
  "John":           { display: "John",                 aliases: ["jn", "joh"] },
  "Acts":           { display: "Acts",                 aliases: ["ac", "acts of the apostles"] },
  "Romans":         { display: "Romans",               aliases: ["rom", "ro"] },
  "1 Corinthians":  { display: "1 Corinthians",        aliases: ["1 cor", "1cor"] },
  "2 Corinthians":  { display: "2 Corinthians",        aliases: ["2 cor", "2cor"] },
  "Galatians":      { display: "Galatians",            aliases: ["gal"] },
  "Ephesians":      { display: "Ephesians",            aliases: ["eph"] },
  "Philippians":    { display: "Philippians",          aliases: ["phil", "php"] },
  "Colossians":     { display: "Colossians",           aliases: ["col"] },
  "1 Thessalonians":{ display: "1 Thessalonians",      aliases: ["1 thess", "1thess", "1 th"] },
  "2 Thessalonians":{ display: "2 Thessalonians",      aliases: ["2 thess", "2thess", "2 th"] },
  "1 Timothy":      { display: "1 Timothy",            aliases: ["1 tim", "1tim"] },
  "2 Timothy":      { display: "2 Timothy",            aliases: ["2 tim", "2tim"] },
  "Titus":          { display: "Titus",                aliases: ["tit"] },
  "Philemon":       { display: "Philemon",             aliases: ["phlm", "philem"] },
  "Hebrews":        { display: "Hebrews",              aliases: ["heb"] },
  "James":          { display: "James",                aliases: ["jas", "jm"] },
  "1 Peter":        { display: "1 Peter",              aliases: ["1 pet", "1pet", "1 pt"] },
  "2 Peter":        { display: "2 Peter",              aliases: ["2 pet", "2pet", "2 pt"] },
  "1 John":         { display: "1 John",               aliases: ["1 jn", "1jn", "1 joh"] },
  "2 John":         { display: "2 John",               aliases: ["2 jn", "2jn", "2 joh"] },
  "3 John":         { display: "3 John",               aliases: ["3 jn", "3jn", "3 joh"] },
  "Jude":           { display: "Jude",                 aliases: ["jd"] },
