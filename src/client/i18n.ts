...
const EN: Strings = {
  ...
  footerLine1: "Multiple translations &bull; Offline-ready",
...
const FI: Strings = {
  ...
  footerLine1: "Useita käännöksiä &bull; Toimii offline-tilassa",
  footerFavicon: 'Favicon: &ldquo;Jesus Christ from Hagia Sophia&rdquo;, Edal Anton Lefterov, <a href="https://creativecommons.org/licenses/by-sa/3.0?ref=openverse" target="_blank" rel="noopener noreferrer">CC BY-SA 3.0</a>',
};
